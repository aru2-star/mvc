...
class Grid extends \Block\Core\Grid
{
	...
	public function prepareCollection()
	{
		...
		$payment = $payment->fetchAll($query);
		$this->setCollection($payment);
		return $this;
	}
	...
	public function setPages(){
		...
		$query = "SELECT * FROM `{$paymentModel->getTableName()}`";	
		$paymentCount = $paymentModel->getAdapter()->fetchOne($query);
		$this->pages->setTotalRecords($paymentCount);
